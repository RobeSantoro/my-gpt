...
function ChatForm({ messages, setMessages }) {
    ...
    const handleSubmit = async (e) => {
        ...
        // user's chatstripe
        const updatedMessages = [{ role: 'system', content: 'You are a helpful assistant, that says "Sir" at the beginning of every answer.' }, ...messages, { role: 'user', content: messageInput }];
        setMessages([...messages, { role: 'user', content: messageInput }]);
